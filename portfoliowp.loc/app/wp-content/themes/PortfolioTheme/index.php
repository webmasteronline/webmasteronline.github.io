		...
		<div class="">
			<div class="filter_div controls">
				<div class="row">
					<ul>
						...
						<li class="filter" data-filter=".front_end">Фронтенд</li>
						<li class="filter" data-filter=".back_end">Бэкенд</li>
						<li class="filter" data-filter=".disine">Дизайн</li>						
						<li class="filter" data-filter=".small_work">Мелкие работы</li>
					</ul>
				</div>
			</div>
			<div id="portfolio_grid">
				<div class="row justify-content-center">
						...
						<div class="mix col-auto portfolio-item <?php
